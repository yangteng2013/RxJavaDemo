...
public class SmoothBarActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        simpleFragmentPagerAdapter.addFragment("工友圈", RecyclerPageFragment.newInstance(1));
        simpleFragmentPagerAdapter.addFragment("匿名八卦", RecyclerPageFragment.newInstance(2));
